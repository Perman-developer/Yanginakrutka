...
from database_funk.users_funk import create_tables
from database_funk.orders_funk import create_services_table
from database_funk.order_funk import update_services_cache
#HANDLERLAR
from handlers.user_handlers import start, referal, my_balance, support, payment, buyurtma, buyurtma_davomi, buyurtmalar
#ADMIN HANDLERLAR
from handlers.admin_handlers import javob_yoz, panel, statistika, xizmat_qoshish, xizmat_tahrirla, api_qosh, foydalanuvchi_boshqarish, tolov_tasdiqla, xabar_yuborish
...
dp.include_router(xabar_yuborish.router)
